...
class MainGUI( baseInterface.BasePsWindow ):
    ...
    def connect_event_handlers(self):
        ...
        dispaly_grp = [ self.ui.dis_over_btn, self.ui.dis_ref_btn, self.ui.dis_norm_btn,
        ...
        freeze_tm_grp = [ self.ui.ft_all_btn, self.ui.ft_translate_btn,
        ...
        ## SRT TAB ##
        # Reset srt ui list
        reset_srt_grp = [ self.ui.r_translate_btn, self.ui.r_rotate_btn, self.ui.r_scale_btn,
        ...
        lock_hide_check_grp = { 'translateX' : self.ui.lh_tx_check, 'translateY' : self.ui.lh_ty_check, 'translateZ' : self.ui.lh_tz_check,
        ...
        lock_hide_btn_grp = [ self.ui.lh_k_btn, self.ui.lh_l_btn, self.ui.lh_h_btn,
        ...
        joint_orient_opt_grp = { 'aimX' : self.ui.jo_aimX_rdbtn, 'aimY' : self.ui.jo_aimY_rdbtn, 'aimZ' : self.ui.jo_aimZ_rdbtn,
        ...
        mirror_joint_opt_grp = { 'acrossXY' : self.ui.mj_XY_rdbtn, 'acrossYZ' : self.ui.mj_YZ_rdbtn, 'acrossXZ' : self.ui.mj_XZ_rdbtn,
        ...
        coloroveride_btn_grp = [ self.ui.color_06_btn, self.ui.color_09_btn, self.ui.color_13_btn, self.ui.color_14_btn, self.ui.color_17_btn ]
        ...
        self.ui.cc_create_btn.pressed.connect( partial( self.create_control_pressed, self.ui.cc_create_btn, control_setting_grp ) )
    ...
    def display_pressed(self, sender):
        ...
        if none_bool or jnt_bool:
            ...
            for o in selection: o.drawStyle.set( dis_draw )
        ...
        if axis_bool or noaxis_bool:
            ...
            for o in selection: o.displayLocalAxis.set( dis_axis )
    ...
    def pgroup_pressed(self, sender):
        ...
        FrRigging.pgroup( selection, world = sender['world'].isChecked(),
    ...
    def create_control_pressed(self, sender, setting):
        ...
        for tm, o in tm_list:
            ...
            result = FrRigging.createControl( item_data, name = object_name, transform = tm, suffix = suffixtext, group = group_list )
